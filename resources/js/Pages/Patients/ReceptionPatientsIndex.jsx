...
import {
    Users, Search, Plus, Filter, MoreHorizontal, Eye, Edit, Trash2,
    Phone, Mail, Calendar, MapPin
} from 'lucide-react';

export default function ReceptionPatientsIndex({ patients }) {
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                            Manage patient records and information (Reception Access)
                        </p>
                    </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <CardTitle className="flex items-center">
                                    ...
                                    All Patients (Full Access)
                                </CardTitle>
                                <CardDescription>
                                    {filteredPatients.length} patients found - Reception can manage all patient records
                                </CardDescription>
                            </div>
                        </div>
                    </CardHeader>
