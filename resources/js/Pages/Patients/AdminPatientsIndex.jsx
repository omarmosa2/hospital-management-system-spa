...
export default function AdminPatientsIndex({ patients }) {
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                            View patient records and information (Admin Access)
                        </p>
                    </div>
                </div>
            }
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <CardTitle className="flex items-center">
                                    ...
                                    All Patients (View Only)
                                </CardTitle>
                                <CardDescription>
                                    {filteredPatients.length} patients found - Admin can only view patient records
                                </CardDescription>
                            </div>
                        </div>
                    </CardHeader>
