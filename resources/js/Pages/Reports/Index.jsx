...
import {
    ...
    Printer, Filter, Search, Eye, AlertCircle
} from 'lucide-react';

export default function ReportsIndex({ reports, auth }) {
    ...
    const canExportReports = userRole === 'admin';
                ...
                <Card>
                    <CardContent className="text-center py-12">
                        ...
                        <p className="text-gray-500">
                            {userRole === 'reception' && 'Reception staff do not have access to reports and analytics.'}
                            {userRole === 'doctor' && 'Doctors do not have access to reports and analytics.'}
                        </p>
                    </CardContent>
                </Card>
            </AuthenticatedLayout>
