...
export default function DoctorsCreate({ clinics = [] }) {
                    ...
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                                أدخل بيانات الطبيب الجديد في النظام
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            أدخل المعلومات الشخصية والمهنية الأساسية للطبيب
                        </CardDescription>
                    </CardHeader>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            تحديد الأجور والنسب المالية للطبيب
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            حدد أيام وساعات العمل للطبيب لكل يوم على حدة
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                ...
                <div className="flex justify-end space-x-4">
                    ...
                    <Button type="submit" disabled={processing}>
                        ...
                        {processing ? 'جاري الحفظ...' : 'حفظ الطبيب'}
                    </Button>
                </div>
            </form>
        </AuthenticatedLayout>
